...
public class RecordActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (checkPermission()) {
            ...
            ActivityCompat.requestPermissions(RecordActivity.this,
                    new String[]{Manifest.permission.RECORD_AUDIO}, 1234);
        }
        ...
        switch (requestCode) {
            case 1234: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(RecordActivity.this, "Permission not granted", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        }
    ...
    private boolean checkPermission() {
        int permissionCheck_Cam = ContextCompat.checkSelfPermission(RecordActivity.this,
